...
"if"	{ std::cout<<"KW_IF"<<std::endl; 	return token::IF; }
"then"	{ std::cout<<"KW_THEN"<<std::endl; 	return token::THEN; }
"else"	{ std::cout<<"KW_ELSE"<<std::endl; 	return token::ELSE; }
"while"	{ std::cout<<"KW_WHILE"<<std::endl;	return token::WHILE; }
"do"	{ std::cout<<"KW_DO"<<std::endl;		return token::DO; }
